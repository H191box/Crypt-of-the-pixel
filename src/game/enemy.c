...
static const s16 s_enemy_stats[ENEMY_MAX][7] = {
    /* SLIME     */ {  8,  3,  1, 1,  5,  3, 0 },
    /* BAT       */ {  5,  4,  0, 2,  4,  2, 3 },
    /* SKELETON  */ { 15,  5,  3, 1, 10,  8, 6 },
    /* GHOST     */ { 12,  6,  1, 2, 12, 10, 9 },
    /* ORC       */ { 20,  7,  5, 1, 15, 12, 12 },
    /* BOSS_SLIME   */ { 50, 10,  5, 1, 50, 100, 15 },
    /* BOSS_SKELE   */ { 60, 12,  8, 1, 60, 120, 17 },
    /* BOSS_DEMON   */ { 80, 15, 10, 2, 80, 150, 19 },
};
